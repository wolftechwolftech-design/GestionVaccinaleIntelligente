  ...
  return (
    <div>
      ...
      <div className="btn-row" style={{marginBottom:16}}>
        <button className="btn btn-primary" onClick={async()=>{toast("⏳ Génération...");await exportStockPDF(vaccins);}}>
          📄 Stock vaccinal
        </button>
        <button className="btn btn-primary" onClick={async()=>{toast("⏳ Génération...");await exportRelevesPDF(releves,"","");}}>
          📄 Feuille de température
        </button>
      </div>
      {releves.length>1&&<TempChart releves={releves}/>}
      <div className="card">
